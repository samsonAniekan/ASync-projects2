...
function postponeWithArgs(cb, delay) {
  // Your code here
  return function(...arg) {
    return arg +  setTimeout(function () {
      cb(...arg)
    }, delay)
  }
...
const printSum = (num1, num2) => console.log(num1 + num2);
const slowPrintSum = postponeWithArgs(printSum, 2000);
slowPrintSum(4, 3); // prints '7' after 500 ms
slowPrintSum(2, 8); // prints '10' after 500 ms; // prints 'Hello Alex!' after 1000 ms // prints 'Hello Alex!' after 1000 ms
